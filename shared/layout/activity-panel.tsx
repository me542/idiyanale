...
import NewTicketPanelView, {
    NewTicketFormData,
} from "./Activity/service-request";

// import ChangedRequestPanelView, {
//     ChangedRequestFormData,
// } from "./Activity/changed-request";

// import IncidentReportPanelView, {
//     IncidentReportFormData,
// } from "./Activity/incident-report";

// import ProblemManagementPanelView, {
//     ProblemManagementFormData,
// } from "./Activity/problem-management";

import MinorTaskPanelView, {
    MinorTaskFormData,
} from "./Activity/minor-task";
...
export default function ActivityPanel({
    ...
    /**
     * Handle clicking an activity from the menu.
     */
    ...
    /**
     * Close the complete activity panel.
     */
    ...
    /**
     * Changed Request submit.
     */
    // const handleChangedRequestSubmit = (
    //     data: ChangedRequestFormData
    // ) => {
    //     console.log("Changed request submitted:", data);
    ...
    // /**
    //  * Problem Management submit.
    //  */
    // const handleProblemManagementSubmit = (
    //     data: ProblemManagementFormData
    // ) => {
    //     console.log("Problem management submitted:", data);
     ...
     * Minor Task submit.
     */
    const handleMinorTaskSubmit = (
        data: MinorTaskFormData
    ) => {
    ...
    return (
        <>
            ...
            >
                ...
                {/* {view === "changed-request" && (
                    <ChangedRequestPanelView
                        onCancel={handleBackToMenu}
                        onSubmit={
                            handleChangedRequestSubmit
                        }
                    />
                )} */}
                ...
                {/* {view === "problem-management" && (
                    <ProblemManagementPanelView
                        onCancel={handleBackToMenu}
                        onSubmit={
                            handleProblemManagementSubmit
                        }
                    />
                )} */}
